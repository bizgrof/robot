    ...
    <form>
        <div class="account__common">
            <div class="account__name">
                <input type="text" placeholder="Фамилия" class="account__input" name="second_name">
                <input type="text" placeholder="Имя" class="account__input" name="name">
                <input type="text" placeholder="Отчество" class="account__input" name="middle_name">
            </div>
        ...
        <div class="account__other">
            <div data-content="Телефон:" class="account__block account__block_select">
                <input type="tel" placeholder="+7 (900) 800-8080" class="account__input" name="phone">
            </div>
            ...
            <div data-content="Пол:" class="account__block">
                <input type="radio" name="sex" id="man" checked class="account__radio" name="gender">
