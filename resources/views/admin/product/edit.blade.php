    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1">
                @include('admin.product.parts.edit.tab_1')
            </div>
            <div class="tab-pane" id="tab_2">
                @include('admin.product.parts.edit.tab_2')
            </div>
            <div class="tab-pane" id="tab_3">
                @include('admin.product.parts.edit.tab_3')
            </div>
            <div class="tab-pane" id="tab_4">
                @include('admin.product.parts.edit.tab_4')
            </div>
        </div>
    </div>
